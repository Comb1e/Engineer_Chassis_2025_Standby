...
#define RIGHT_SUCKER_POSITION_ROLL      (90.0f)
...
#define SIDE_SUCKER_POSITION_RYP_VEL  (0.4f)

#define ARM_SUCKER_POSITION_XYZ_VEL   (1.4f)
#define ARM_SUCKER_POSITION_RYP_VEL   (0.4f)
...
#define BACK_HOME_POSITION_RYP_VEL  (0.4f)
